...
import NatGeoMapMaker from "@/pages/natgeo-mapmaker";
import ArcGISHub from "@/pages/arcgis-hub";
import TrubelAtlas from "@/pages/trubel-atlas";
import DataCommons from "@/pages/data-commons";
  ...
  return (
    <Switch>
      ...
      <Route path="/ai-copilot">
        <div className="ai-copilot-page h-screen"> {/* Apply the class here */}
          <AICopilot />
        </div>
      </Route>
      ...
      <Route path="/mapping/natgeo-mapmaker">
        <ProtectedRoute>
          <Layout>
            <NatGeoMapMaker />
          </Layout>
      ...
      <Route path="/mapping/trubel-atlas">
        <ProtectedRoute>
          <Layout>
            <TrubelAtlas />
          </Layout>
      ...
      <Route path="/mapping/data-commons">
        <ProtectedRoute>
          <Layout>
            <DataCommons />
          </Layout>
