...
export function Header() {
  ...
  const handleNotificationClick = (notification: any) => {
    ...
    if (notification.type === 'assignment_graded' && notification.assignmentId) {
      setLocation(`/assignment-submission/${notification.assignmentId}`);
      ...
      if (user?.role === 'student') {
        ...
        setLocation(`/assignment-detail/${notification.assignmentId}`);
      }
